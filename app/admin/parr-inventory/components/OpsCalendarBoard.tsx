...
function cardTone(order: OpsOrder) {
  if (order.hasReassignmentWarning) return "border-orange-400/35 bg-orange-500/10";
                    ...
                    {laneOrders.length === 0 ? (
                      ...
                      laneOrders.map((order) => (
                        <Link
                          ...
                          className={`rounded-2xl border p-4 hover:bg-white/10 ${cardTone(order)}`}
                        >
                          <div className="flex flex-wrap items-start justify-between gap-3">
                            <div>
                          ...
                          {order.primaryReassignmentWarning ? (
                            <div className="mt-2 rounded-xl border border-orange-400/25 bg-orange-500/10 px-3 py-2 text-xs text-orange-100">
                              {order.primaryReassignmentWarning}
                            </div>
                          ) : null}
