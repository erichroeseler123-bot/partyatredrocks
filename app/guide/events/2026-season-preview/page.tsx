  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 bg-black text-white">
      ...
      <div className="grid gap-6 mb-16">
        <Link href="/guide/events/crankdat-march-27" className="p-8 bg-zinc-900/50 border border-zinc-800 rounded-[2.5rem] hover:border-red-600 transition-all group shadow-xl">
          <span className="text-red-600 font-bold uppercase text-xs tracking-widest font-mono">March 27, 2026</span>
          <h3 className="text-2xl font-black mt-2 uppercase italic tracking-tight text-white group-hover:text-red-500 transition-colors">CRANKDAT</h3>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <Link href="/guide/logistics/winter-survival" className="p-8 bg-zinc-950 border border-zinc-800 rounded-[2.5rem] hover:border-blue-500 transition-all">
          <h4 className="text-blue-400 font-black uppercase tracking-tighter mb-2 italic">Winter Survival</h4>
        ...
        <Link href="/guide/logistics/shuttle-vs-westracks-2026" className="p-8 bg-zinc-950 border border-zinc-800 rounded-[2.5rem] hover:border-yellow-600 transition-all">
          <h4 className="text-yellow-600 font-black uppercase tracking-tighter mb-2 italic">vs. Public Shuttle</h4>
          <p className="text-zinc-500 text-sm text-left font-medium">Why we are the only reliable night service in 2026. No surge, no waits.</p>
        </Link>
      </div>
