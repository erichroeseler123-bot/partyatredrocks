...
export default function WestracksComparison() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 bg-black text-white">
      ...
      <div className="bg-zinc-900 p-10 rounded-[2.5rem] border border-red-600 text-center">
        ...
        <Link href="/book-shuttle" className="bg-red-600 text-white px-10 py-4 rounded-full font-black uppercase hover:bg-red-500 transition shadow-xl inline-block">
          Secure Your Ride
        </Link>
      </div>
    </div>
