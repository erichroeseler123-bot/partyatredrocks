  ...
  return (
    <main className="min-h-screen bg-surface text-white px-6 py-20">
        ...
        <div className="mt-10">
          ...
          <div className="mt-4 space-y-3">
            <details className="rounded-2xl border border-soft bg-surface-strong p-5">
              ...
              <p className="mt-2 text-soft leading-relaxed">Closest varies by where you enter—arriving early is what actually determines proximity.</p>
            </details>
            <details className="rounded-2xl border border-soft bg-surface-strong p-5">
              <summary className="cursor-pointer font-black">How do I get out faster?</summary>
              <p className="mt-2 text-soft leading-relaxed">Choose a departure route before the show ends and avoid the biggest crowd funnels.</p>
            </details>
            <details className="rounded-2xl border border-soft bg-surface-strong p-5">
              <summary className="cursor-pointer font-black">Is it okay to tailgate?</summary>
              <p className="mt-2 text-soft leading-relaxed">Follow venue rules for the event—some nights are stricter than others.</p>
            </details>
          </div>
        </div>
      ...
      />
        ...
        <footer className="mt-16 border-t border-soft pt-10 text-sm text-muted">
          Parking changes by show size, arrival time, and exit route. Plan ahead or book a ride before show night.
        </footer>
      </div>
    </main>
  );
