        ...
        <div className="mt-10">
          ...
          <div className="mt-4 space-y-3">
            <details className="rounded-2xl border border-white/10 bg-surface-strong p-5">
              ...
              <p className="mt-2 text-zinc-300 leading-relaxed">Small, simple bags that are easy to screen. Avoid complicated pockets and oversized bags.</p>
            </details>
            <details className="rounded-2xl border border-white/10 bg-surface-strong p-5">
              <summary className="cursor-pointer font-black">Will they really turn me away?</summary>
              <p className="mt-2 text-zinc-300 leading-relaxed">Yes—especially on busy nights when screening is strict and lines are long.</p>
            </details>
            <details className="rounded-2xl border border-white/10 bg-surface-strong p-5">
              <summary className="cursor-pointer font-black">What’s the safest move?</summary>
              <p className="mt-2 text-zinc-300 leading-relaxed">Bring as little as possible.</p>
            </details>
          </div>
        </div>
