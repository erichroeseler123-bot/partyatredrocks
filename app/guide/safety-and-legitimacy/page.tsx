...
export default function SafetyAndLegitimacy() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-20 bg-black text-white">
      ...
      <section className="bg-zinc-900/50 border border-zinc-800 rounded-[2.5rem] p-8 mb-10 shadow-2xl">
        ...
        <ul className="space-y-6">
          <li className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm mt-1">Every driver undergoes mandatory fingerprint-based criminal background checks—a standard we never compromise.</p>
            </div>
          </li>
          <li className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm mt-1">We maintain comprehensive commercial insurance that exceeds all state requirements for luxury passenger transport.</p>
            </div>
          </li>
          <li className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm mt-1">We never utilize surge pricing. Your $250 group minimum or $55 seat is locked in the moment you book.</p>
            </div>
          </li>
        </ul>
      </section>
      ...
      <div className="mt-16 text-center border-t border-zinc-900 pt-10">
        <Link href="/book-shuttle" className="bg-red-600 hover:bg-red-500 text-white px-10 py-4 rounded-full font-black uppercase tracking-widest transition shadow-xl inline-block">
