        ...
        <div className="mt-10">
          ...
          <div className="mt-4 space-y-3">
            <details className="rounded-2xl border border-white/10 bg-surface-strong p-5">
              ...
              <p className="mt-2 text-zinc-300 leading-relaxed">It can be, but it’s the highest-failure window due to surge, traffic patterns, and pickup enforcement.</p>
            </details>
            <details className="rounded-2xl border border-white/10 bg-surface-strong p-5">
              <summary className="cursor-pointer font-black">What’s the most reliable option?</summary>
              <p className="mt-2 text-zinc-300 leading-relaxed">A scheduled shuttle or pre-arranged private pickup with a defined meet point.</p>
            </details>
            <details className="rounded-2xl border border-white/10 bg-surface-strong p-5">
              <summary className="cursor-pointer font-black">Where is the main pickup chaos?</summary>
              <p className="mt-2 text-zinc-300 leading-relaxed">Lower areas and rideshare zones right after encore—timing and meet points matter.</p>
            </details>
          </div>
        </div>
