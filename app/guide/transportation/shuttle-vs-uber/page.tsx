        ...
        <div className="mt-10">
          ...
          <div className="mt-4 space-y-3">
            <details className="rounded-2xl border border-soft bg-surface-strong p-5">
              ...
              <p className="mt-2 text-soft leading-relaxed">Everyone requests at once, traffic patterns compress, and pickups are constrained to specific zones.</p>
            </details>
            <details className="rounded-2xl border border-soft bg-surface-strong p-5">
              <summary className="cursor-pointer font-black">Is a shuttle worth it?</summary>
              <p className="mt-2 text-soft leading-relaxed">If you value certainty and a guaranteed ride back, yes.</p>
            </details>
            <details className="rounded-2xl border border-soft bg-surface-strong p-5">
              <summary className="cursor-pointer font-black">What’s the best choice for groups?</summary>
              <p className="mt-2 text-soft leading-relaxed">Shuttle for budget + simplicity; private SUV for control and comfort.</p>
            </details>
          </div>
        </div>
