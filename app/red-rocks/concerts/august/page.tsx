...
export const metadata = {
  ...
  description: "August 2026 lineup at Red Rocks with direct links to show intel and ride booking.",
      ...
      <section className="comic-wrap">
        <div className="comic-hero">
          ...
          <p className="comic-copy">
            Full August event view for Red Rocks. Open show intel pages, then lock transport before high-demand nights.
          </p>
