...
export const metadata = {
  ...
  description: "July 2026 lineup at Red Rocks with direct links to show details and ride booking.",
      ...
      <section className="comic-wrap">
        <div className="comic-hero">
          ...
          <p className="comic-copy">
            Full July event view for Red Rocks. See show details, then book your ride before high-demand nights.
          </p>
