    ...
    <main className="mx-auto max-w-6xl px-4 py-12">
      <div className="rounded-[32px] border border-white/10 bg-white/[0.04] p-8 shadow-[0_22px_70px_rgba(0,0,0,0.45)] backdrop-blur-xl">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          <Link
            href="/scene/jam"
            className="inline-flex items-center justify-center rounded-full border border-white/14 bg-white/5 px-7 py-3 text-[12px] font-black uppercase tracking-[0.22em] text-white/90 hover:bg-white/10 transition"
          >
            Back to Jam Hub →
          </Link>
          <Link
            href="/book?scene=jam"
            className="inline-flex items-center justify-center rounded-full bg-neon-blue px-7 py-3 text-[12px] font-black uppercase tracking-[0.22em] text-black hover:bg-white transition"
          >
            Plan Your Ride
          </Link>
        </div>
        ...
        {JAM_FESTIVALS.map((f) => (
          <div key={f.slug} className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 hover:bg-white/[0.05] transition">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link
                href={f.bookHref}
                className="inline-flex items-center justify-center rounded-full bg-neon-blue px-5 py-2.5 text-[12px] font-black uppercase tracking-[0.22em] text-black hover:bg-white transition"
              >
                Shuttle Plan
              </Link>
              <a
                ...
                className="inline-flex items-center justify-center rounded-full border border-white/14 bg-white/5 px-5 py-2.5 text-[12px] font-black uppercase tracking-[0.22em] text-white/85 hover:bg-white/10 transition"
              >
                Official Info →
              </a>
            </div>
