...
const IMAGE_MAP: any = {
  ...
  "inzo": "https://seatgeek.com/images/performers-landscape/inzo-2a3b4c/123456/huge.jpg",
  "ethel-cain": "https://seatgeek.com/images/performers-landscape/ethel-cain-0e2f1d/987654/huge.jpg"
};
...
export default async function ShowPage(props: { params: Promise<{ id: string }> }) {
  ...
  // Fallback to the hardcoded map if SeatGeek data is pending
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      {/* 18:30 PEAK HERO RESTORATION */}
      <div className="relative h-[65vh] w-full overflow-hidden border-b border-white/10">
        <img src={heroImage} className="w-full h-full object-cover opacity-50 grayscale hover:grayscale-0 transition-all duration-1000" />
      ...
      <div className="grid grid-cols-12 gap-12 p-12">
        <div className="col-span-4 space-y-12">
          ...
          <div className="p-10 rounded-[3rem] bg-zinc-900/50 border border-white/5 shadow-2xl">
            ...
            <p className="text-zinc-300 text-lg leading-relaxed font-medium italic">Performance profile active. Secure shuttle booking recommended.</p>
          </div>
        </div>
