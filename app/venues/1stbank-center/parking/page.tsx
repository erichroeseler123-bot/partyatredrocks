...
export const metadata = {
  title: "1stBank Center Parking Guide | Broomfield Tips 2026",
  description:
    "Parking options at 1stBank Center for 2026 shows. Venue lots, nearby garages, tips to avoid hassle, and shuttle or rideshare alternatives.",
  alternates: { canonical: `${SITE}/venues/1stbank-center/parking` },
};

export default function FirstBankParking() {
  return (
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          <div className="comic-kicker">Broomfield Venue Guide</div>
          <h1 className="comic-title">1stBank Center Parking Guide</h1>
        ...
        <div className="comic-grid" style={{ marginTop: 32 }}>
          <article className="comic-panel">
            ...
            <ul className="comic-copy mt-4 space-y-4 list-disc pl-6">
              ...
              <li><strong>Nearby Broomfield Garages/Lots</strong> - Usually available within a short walk depending on lineup.</li>
