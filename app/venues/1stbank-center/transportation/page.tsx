...
export const metadata = {
  title: "1stBank Center Transportation Guide | Broomfield 2026",
  description:
    "How to get to 1stBank Center in Broomfield. Shuttle vs Uber vs driving vs transit options for 2026 shows with post-show exit tips.",
  alternates: { canonical: `${SITE}/venues/1stbank-center/transportation` },
};

export default function FirstBankTransportation() {
  return (
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          <div className="comic-kicker">Broomfield Venue Guide</div>
          <h1 className="comic-title">1stBank Center Transportation Guide</h1>
