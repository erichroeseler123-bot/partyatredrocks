...
export const metadata = {
  title: "Best Time to Arrive at Ball Arena | Denver Concert Tips 2026",
  description:
    "When to arrive at Ball Arena for 2026 shows. Recommended windows by ticket type, parking buffer, entry flow, and post-show exit plan.",
  alternates: { canonical: `${SITE}/venues/ball-arena/best-time-to-arrive` },
};

export default function BallArenaBestTimeToArrive() {
  return (
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          <div className="comic-kicker">Denver Venue Guide</div>
          <h1 className="comic-title">Best Time to Arrive at Ball Arena</h1>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 mt-6 w-full px-4">
            ...
            <Link href="/venues/ball-arena/parking" className="comic-btn comic-btn-secondary w-full sm:w-auto min-w-[200px] text-center">
              Parking Strategy
            </Link>
          </div>
        </div>
