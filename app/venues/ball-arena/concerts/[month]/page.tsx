...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Ball Arena ${month.label} 2026 schedule with artist links, show details, and ride options.`,
    ...
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          ...
          <p className="comic-copy">Monthly schedule for Ball Arena in {month.label}. Open show details and plan your ride before show night.</p>
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 mt-6 w-full px-4">
            ...
            <Link href="/book?venue=ball-arena" className="comic-btn comic-btn-primary w-full sm:w-auto min-w-[180px] text-center">
              Book a Ride
            </Link>
          </div>
        </div>
