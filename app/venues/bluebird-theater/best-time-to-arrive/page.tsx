...
export const metadata = {
  title: "Best Time to Arrive at Bluebird Theater | Denver Concert Tips 2026",
  description:
    "When to arrive at Bluebird Theater for 2026 shows. Timing windows by ticket type, parking buffer, and post-show exit strategy.",
  alternates: { canonical: `${SITE}/venues/bluebird-theater/best-time-to-arrive` },
};

export default function BluebirdBestTimeToArrivePage() {
  return (
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          <div className="comic-kicker">Denver Venue Guide</div>
          <h1 className="comic-title">Best Time to Arrive at Bluebird Theater</h1>
          <p className="comic-copy">
            East Colfax gets tight near doors on sold nights. A clear arrival window keeps parking and entry smooth.
          </p>
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 mt-6 w-full px-4">
            ...
            <Link href="/venues/bluebird-theater/parking" className="comic-btn comic-btn-secondary w-full sm:w-auto min-w-[200px] text-center">
              Parking Strategy
            </Link>
          </div>
        </div>
        ...
        <div className="comic-grid" style={{ marginTop: 32 }}>
          <article className="comic-panel">
            ...
            <p className="comic-copy" style={{ marginTop: 8 }}>
              Build extra buffer for East Colfax traffic, parking search, and security line movement on peak nights.
            </p>
          </article>
        ...
        <section className="comic-panel mt-8">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 mt-4 justify-center">
            <Link href="/venues/bluebird-theater/parking" className="comic-btn comic-btn-secondary">Parking</Link>
