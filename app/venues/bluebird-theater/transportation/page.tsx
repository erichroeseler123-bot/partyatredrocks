...
export const metadata = {
  title: "Bluebird Theater Transportation Guide | Denver East Colfax 2026",
  description:
    "How to get to Bluebird Theater in 2026. Compare shuttle, rideshare, driving, and transit with post-show exit strategy.",
  alternates: { canonical: `${SITE}/venues/bluebird-theater/transportation` },
};

export default function BluebirdTransportationPage() {
  return (
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          <div className="comic-kicker">Denver Venue Guide</div>
          <h1 className="comic-title">Bluebird Theater Transportation Guide</h1>
          <p className="comic-copy">
            East Colfax access is simple inbound, but post-show curb demand builds quickly. Use this plan to stay predictable.
          </p>
