...
export const metadata = {
  title: "Fiddler's Green Amphitheatre Parking Guide | Greenwood Village Tips 2026",
  description:
    "Parking options at Fiddler's Green Amphitheatre for 2026 shows. Venue lots, nearby garages, tips to avoid hassle, and shuttle or rideshare alternatives.",
  alternates: { canonical: `${SITE}/venues/fiddlers-green-amphitheatre/parking` },
};

export default function FiddlersGreenParking() {
  return (
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          <div className="comic-kicker">Greenwood Village Venue Guide</div>
          <h1 className="comic-title">Fiddler's Green Amphitheatre Parking Guide</h1>
        ...
        <div className="comic-grid" style={{ marginTop: 32 }}>
          <article className="comic-panel">
            ...
            <ul className="comic-copy mt-4 space-y-4 list-disc pl-6">
              ...
              <li><strong>Nearby Greenwood Village Garages/Lots</strong> - Usually available within a short walk depending on lineup.</li>
              <li><strong>Street Parking</strong> - Limited around amphitheatre and not ideal on event nights.</li>
            </ul>
          </article>
