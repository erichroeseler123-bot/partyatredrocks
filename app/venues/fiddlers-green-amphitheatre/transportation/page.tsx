...
export const metadata = {
  title: "Fiddler's Green Amphitheatre Transportation Guide | Greenwood Village 2026",
  description:
    "How to get to Fiddler's Green Amphitheatre in Greenwood Village. Shuttle vs Uber vs driving vs transit options for 2026 shows with post-show exit tips.",
  alternates: { canonical: `${SITE}/venues/fiddlers-green-amphitheatre/transportation` },
};

export default function FiddlersGreenTransportation() {
  return (
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          <div className="comic-kicker">Greenwood Village Venue Guide</div>
          <h1 className="comic-title">Fiddler's Green Amphitheatre Transportation Guide</h1>
          <p className="comic-copy">
            Suburban amphitheatre with good highway access but high post-show demand. Compare options for 2026 shows.
          </p>
