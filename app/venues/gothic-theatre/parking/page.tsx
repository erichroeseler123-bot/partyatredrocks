...
export const metadata = {
  title: "Gothic Theatre Parking Guide | Denver South Broadway Tips 2026",
  description:
    "Parking options for Gothic Theatre shows in 2026. Lot and street strategy, curb pressure, and why pre-booked rides reduce friction.",
  alternates: { canonical: `${SITE}/venues/gothic-theatre/parking` },
};

export default function GothicParkingPage() {
  return (
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          <div className="comic-kicker">Denver Venue Guide</div>
          <h1 className="comic-title">Gothic Theatre Parking Guide</h1>
          <p className="comic-copy">
            South Broadway parking can bottleneck fast on show nights. This guide helps you avoid late-stage parking drift.
          </p>
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 mt-6 w-full px-4">
            ...
            <Link href="/venues/gothic-theatre/best-time-to-arrive" className="comic-btn comic-btn-secondary w-full sm:w-auto min-w-[200px] text-center">
              Best Arrival Time
            </Link>
          </div>
        </div>
        ...
        <div className="comic-grid" style={{ marginTop: 32 }}>
          ...
          <article className="comic-panel">
            ...
            <p className="comic-copy mt-4">
              Fixed meetup, no lot search, and cleaner post-show regrouping on South Broadway.
            </p>
        ...
        <section className="comic-panel mt-8">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 mt-4 justify-center">
            <Link href="/venues/gothic-theatre/best-time-to-arrive" className="comic-btn comic-btn-secondary">Best Time to Arrive</Link>
