...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Levitt Pavilion Denver ${month.label} 2026 schedule with artist links, show details, and ride options.`,
    ...
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          ...
          <p className="comic-copy">Monthly schedule for Levitt Pavilion Denver in {month.label}. Open show details and plan your ride before show night.</p>
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 mt-6 w-full px-4">
            ...
            <Link href="/book?venue=levitt-pavilion-denver" className="comic-btn comic-btn-primary w-full sm:w-auto min-w-[180px] text-center">
              Book a Ride
            </Link>
          </div>
        </div>
              ...
              {events.map((event) => (
                <article key={event.id} className="comic-panel">
                  ...
                  <div style={{ marginTop: 10, display: "flex", gap: 8, flexWrap: "wrap" }}>
                    ...
                    <Link href="/book?venue=levitt-pavilion-denver" className="comic-btn comic-btn-primary">
                      Get a Ride
                    </Link>
                  </div>
                </article>
