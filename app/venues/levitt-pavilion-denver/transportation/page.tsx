...
export const metadata = {
  title: "Levitt Pavilion Denver Transportation Guide | Denver Ruby Hill 2026",
  description:
    "How to get to Levitt Pavilion Denver in 2026. Compare shuttle, rideshare, driving, and transit with post-show exit strategy.",
  alternates: { canonical: `${SITE}/venues/levitt-pavilion-denver/transportation` },
};

export default function LevittTransportationPage() {
  return (
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          <div className="comic-kicker">Denver Venue Guide</div>
          <h1 className="comic-title">Levitt Pavilion Denver Transportation Guide</h1>
          <p className="comic-copy">
            Ruby Hill access is simple inbound, but post-show curb demand builds quickly. Use this plan to stay predictable.
          </p>
