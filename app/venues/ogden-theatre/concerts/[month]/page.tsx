...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Ogden Theatre ${month.label} 2026 schedule with artist links, show details, and ride options.`,
    ...
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          ...
          <p className="comic-copy">Monthly schedule for Ogden Theatre in {month.label}. Open show details and plan your ride before show night.</p>
              ...
              {events.map((event) => (
                <article key={event.id} className="comic-panel">
                  ...
                  <div style={{ marginTop: 10, display: "flex", gap: 8, flexWrap: "wrap" }}>
                    ...
                    <Link href="/book?venue=ogden-theatre" className="comic-btn comic-btn-primary">
                      Get a Ride
                    </Link>
                  </div>
                </article>
