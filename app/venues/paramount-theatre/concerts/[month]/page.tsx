...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Paramount Theatre ${month.label} 2026 schedule with artist links, show details, and ride options.`,
    ...
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          ...
          <p className="comic-copy">Monthly schedule for Paramount Theatre in {month.label}. Open show details and plan your ride before show night.</p>
