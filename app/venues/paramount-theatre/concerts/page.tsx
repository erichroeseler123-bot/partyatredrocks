...
export const metadata = {
  ...
  description:
    "Full 2026 lineup at Paramount Theatre. Browse upcoming dates, artist links, and pre-filled ride booking options.",
      ...
      <section className="comic-wrap">
        <div className="comic-hero">
          ...
          <p className="comic-copy">
            Historic downtown Denver lineup for 2026 with artist drill-down and direct ride-booking links.
          </p>
