...
export const metadata = {
  title: "Paramount Theatre Transportation Guide | Denver downtown Denver 2026",
  description:
    "How to get to Paramount Theatre in 2026. Compare shuttle, rideshare, driving, and transit with post-show exit strategy.",
  alternates: { canonical: `${SITE}/venues/paramount-theatre/transportation` },
};

export default function ParamountTransportationPage() {
  return (
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          <div className="comic-kicker">Denver Venue Guide</div>
          <h1 className="comic-title">Paramount Theatre Transportation Guide</h1>
          <p className="comic-copy">
            downtown Denver access is simple inbound, but post-show curb demand builds quickly. Use this plan to stay predictable.
          </p>
