...
const RED_ROCKS_SCHEDULE = [
  ...
  { date: "2026-04-15", event: "John Mulaney", support: "Mister Whatever Tour" },
  ...
  { date: "2026-04-23", event: "Subtronics", support: "Cyclops Rocks VI - Night 1" },
  { date: "2026-04-24", event: "Subtronics", support: "Cyclops Rocks VI - Night 2" },
  { date: "2026-04-26", event: "Bob Moses & Cannons", support: "Special Guests" },
  { date: "2026-04-28", event: "Lewis Capaldi", support: "Joy Crookes N1" },
  { date: "2026-04-29", event: "Lewis Capaldi", support: "Joy Crookes N2" },
  ...
  { date: "2026-05-16", event: "LSDREAM", support: "DREAMROCKS II (Day + Night)" },
  ...
  { date: "2026-05-23", event: "FISHER", support: "Special Guests" },
  { date: "2026-05-24", event: "Alabama Shakes", support: "JJ Grey & Mofro N1" },
  { date: "2026-05-25", event: "Alabama Shakes", support: "JJ Grey & Mofro N2" },
  ...
  { date: "2026-06-15", event: "Rod Stewart", support: "Richard Marx N1" },
  { date: "2026-06-16", event: "Rod Stewart", support: "Richard Marx N2" },
  { date: "2026-06-17", event: "Amyl and The Sniffers", support: "L7, PARTY DOZEN" },
  { date: "2026-06-18", event: "THIRD DAY", support: "Michael W. Smith, Matt Maher" },
  ...
  { date: "2026-07-02", event: "Zeds Dead", support: "DEADROCKS XII N1" },
  { date: "2026-07-03", event: "Zeds Dead", support: "DEADROCKS XII N2" },
  { date: "2026-07-10", event: "Avett Brothers", support: "The Lemonheads" },
  { date: "2026-07-11", event: "Avett Brothers", support: "Asleep At The Wheel" },
  { date: "2026-07-12", event: "Avett Brothers", support: "Graham Nash" },
  { date: "2026-07-14", event: "KALEO", support: "Elle King" },
  { date: "2026-07-15", event: "Head And The Heart", support: "Colorado Symphony" },
  { date: "2026-07-16", event: "Head And The Heart", support: "Wilderado" },
  { date: "2026-07-17", event: "String Cheese Incident", support: "Special Guests N1" },
  { date: "2026-07-18", event: "String Cheese Incident", support: "Special Guests N2" },
  ...
  { date: "2026-08-13", event: "Mt. Joy", support: "Night 1" },
  { date: "2026-08-14", event: "Mt. Joy", support: "Night 2" },
  ...
  { date: "2026-09-04", event: "MANÁ", support: "Night 1" },
  { date: "2026-09-05", event: "MANÁ", support: "Night 2" },
  { date: "2026-09-06", event: "Gregory Alan Isakov", support: "Colorado Symphony N1" },
  { date: "2026-09-07", event: "Gregory Alan Isakov", support: "Colorado Symphony N2" },
  ...
  { date: "2026-10-29", event: "Cypress Hill", support: "Method Man & Redman" },
  { date: "2026-11-14", event: "mike.", support: "DJ Stevie Daniels Closing N1" },
  { date: "2026-11-15", event: "mike.", support: "DJ Stevie Daniels Closing N2" }
];
...
export default function RedRocksSchedule() {
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "GoSno LLC Red Rocks Shuttle",
    "description": "Professional concert transportation from Denver to Red Rocks Amphitheatre.",
          ...
          <section key={month}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {shows.map((show: any, i: number) => (
                <Link 
                  key={i} 
                  href={`/shows/${show.event.toLowerCase().replace(/ /g, '-').replace(/[^\w-]/g, '')}`}
