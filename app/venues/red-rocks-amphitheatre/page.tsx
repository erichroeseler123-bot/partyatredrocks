...
// THE MASTER 2026 SCHEDULE - FULLY RESTORED
const RED_ROCKS_SCHEDULE = [
  ...
  { date: "2026-04-23", event: "Subtronics: Cyclops Rocks VI", support: "Hedex, KOAN Sound, Eazybaked" },
  { date: "2026-04-24", event: "Subtronics: Cyclops Rocks VI", support: "Effin, Jon Casey, Beastie" },
  { date: "2026-04-26", event: "Bob Moses & Cannons", support: "Special Guests" },
  { date: "2026-04-28", event: "Lewis Capaldi", support: "Joy Crookes" },
  { date: "2026-04-29", event: "Lewis Capaldi", support: "Joy Crookes" },
  ...
  { date: "2026-05-02", event: "Jason Isbell and the 400 Unit", support: "Gillian Welch & David Rawlings" },
  ...
  { date: "2026-05-07", event: "Alejandro Fernández", support: "de Rey a Rey w/ Camila Fernández" },
  ...
  { date: "2026-05-22", event: "Seven Lions", support: "Trivecta, Mitis, Kill the Noise" },
  { date: "2026-05-23", event: "FISHER", support: "Catch & Release Residency" },
  { date: "2026-05-24", event: "Alabama Shakes", support: "JJ Grey & Mofro" },
  { date: "2026-05-25", event: "Alabama Shakes", support: "JJ Grey & Mofro" },
  { date: "2026-05-29", event: "Michael Franti & Spearhead", support: "The Original Wailers" },
  ...
  { date: "2026-06-04", event: "Brit Floyd", support: "THE WALL Anniversary" },
  { date: "2026-06-05", event: "Brit Floyd", support: "DARK SIDE OF THE MOON" },
  { date: "2026-06-06", event: "Big Head Todd and the Monsters", support: "4 Non Blondes" },
  ...
  { date: "2026-06-15", event: "Rod Stewart", support: "Richard Marx" },
  { date: "2026-06-16", event: "Rod Stewart", support: "Richard Marx" },
  { date: "2026-06-17", event: "Amyl and The Sniffers", support: "Special Guests" },
  ...
  { date: "2026-07-02", event: "Zeds Dead", support: "Deadrocks XII Night 1" },
  { date: "2026-07-03", event: "Zeds Dead", support: "Deadrocks XII Night 2" },
  { date: "2026-07-10", event: "The Avett Brothers", support: "The Lemonheads" },
  { date: "2026-07-11", event: "The Avett Brothers", support: "Asleep at the Wheel" },
  { date: "2026-07-12", event: "The Avett Brothers", support: "Graham Nash" },
  { date: "2026-07-14", event: "Kaleo", support: "Elle King" },
  { date: "2026-07-15", event: "The Head and the Heart", support: "Colorado Symphony" },
  { date: "2026-07-16", event: "The Head and the Heart", support: "Wilderado" },
  { date: "2026-07-17", event: "String Cheese Incident", support: "Special Guests" },
  { date: "2026-07-18", event: "String Cheese Incident", support: "Special Guests" },
  { date: "2026-07-29", event: "Parker McCollum", support: "Gary Allan, Josh Abbott Band" },
  ...
  { date: "2026-08-13", event: "Mt. Joy", support: "Night 1 Residency" },
  { date: "2026-08-14", event: "Mt. Joy", support: "Night 2 Residency" },
  ...
  { date: "2026-09-04", event: "Maná", support: "Vivir Sin Aire Tour Night 1" },
  { date: "2026-09-05", event: "Maná", support: "Vivir Sin Aire Tour Night 2" },
  { date: "2026-09-06", event: "Gregory Alan Isakov", support: "Colorado Symphony" },
  { date: "2026-09-07", event: "Gregory Alan Isakov", support: "Colorado Symphony" },
  { date: "2026-09-08", event: "Five Finger Death Punch", support: "Cody Jinks, Eva Under Fire" },
  { date: "2026-09-17", event: "Get the Led Out", support: "Led Zeppelin Tribute" },
  { date: "2026-10-18", event: "Matt Rife", support: "Stay Golden World Tour" },
  { date: "2026-10-23", event: "Mersiv", support: "Two Sets Special" },
  { date: "2026-10-26", event: "Evanescence", support: "Spiritbox, Nova Twins" },
  { date: "2026-10-29", event: "Cypress Hill", support: "Method Man & Redman, De La Soul" },
  { date: "2026-11-14", event: "mike.", support: "DJ Stevie Daniels" },
  { date: "2026-11-15", event: "mike.", support: "DJ Stevie Daniels" }
];
    ...
    <main className="min-h-screen bg-black text-white p-12">
      <div className="mb-20 border-b border-white/5 pb-10 flex justify-between items-end">
        <div>
          ...
          <p className="text-red-600 font-bold uppercase tracking-[0.4em] mt-4 italic text-xs underline decoration-red-600 decoration-2 underline-offset-8">
            2026 Intelligence Feed // 90+ Events
          </p>
        </div>
        <div className="text-right hidden md:block border-l border-white/10 pl-10 font-mono italic">
          ...
          <p className="text-white text-xs font-black">6 Suburbans // 2 Sprinters Active</p>
        </div>
      </div>
      ...
      <div className="space-y-32">
        {Object.entries(groupedShows).map(([month, shows]: [string, any]) => (
          <section key={month}>
            <h2 className="text-red-600 font-black uppercase text-xs mb-10 tracking-[0.5em] italic border-l-4 border-red-600 pl-6">{month}</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {shows.map((show: any, i: number) => (
                <Link 
                  key={i} 
                  href={`/shows/${show.event.toLowerCase().replace(/ /g, '-').replace(/&/g, 'and')}`}
                  className="group relative bg-zinc-900/40 p-8 rounded-[3rem] border border-white/5 hover:border-yellow-400/50 transition-all duration-500 hover:scale-[1.02]"
                >
                  <p className="text-zinc-500 text-[10px] font-black uppercase mb-4 tracking-widest italic font-mono">
                    {new Date(show.date).toLocaleDateString('en-US', { weekday: 'short', month: 'short', day: 'numeric' })}
                  </p>
                  <h3 className="text-2xl font-black italic uppercase leading-none group-hover:text-yellow-400 transition-colors mb-4">
                    {show.event}
                  </h3>
                  <p className="text-zinc-600 text-[10px] font-bold uppercase tracking-widest truncate">{show.support}</p>
                  
                  <div className="mt-8 pt-8 border-t border-white/5 flex justify-between items-center text-zinc-700">
                    <span className="text-[9px] font-black uppercase tracking-widest italic">DCC Intelligence &rarr;</span>
                    <span className="text-red-600 font-black uppercase text-[10px] italic">Shuttle Active</span>
                  </div>
                </Link>
              ))}
            </div>
