...
// THE MASTER 2026 SCHEDULE - ALL 90+ SHOWS
const RED_ROCKS_SCHEDULE = [
  { date: "2026-02-07", event: "Winter on the Rocks", support: "BigXthaPlug, Smino" },
  ...
  { date: "2026-04-16", event: "bbno$", support: "Oliver Tree, Kaarija, YNG Martyr" },
  ...
  { date: "2026-04-19", event: "Wiz Khalifa", support: "2 Chainz, Berner, Underachievers" },
  { date: "2026-04-20", event: "Ice Cube", support: "Big Boi, Czarface" },
  { date: "2026-04-21", event: "Ethel Cain", support: "9Million" },
  { date: "2026-04-23", event: "Subtronics: Cyclops Rocks VI", support: "Hedex, KOAN Sound" },
  { date: "2026-04-24", event: "Subtronics: Cyclops Rocks VI", support: "Effin, Jon Casey" },
  ...
  { date: "2026-05-07", event: "Alejandro Fernández", support: "de Rey a Rey" },
  ...
  { date: "2026-05-17", event: "THE ELOVATERS", support: "Collie Buddz, Protoje" },
  ...
  { date: "2026-05-23", event: "FISHER", support: "Catch & Release" },
  ...
  { date: "2026-07-02", event: "Zeds Dead", support: "Deadrocks XII" },
  { date: "2026-07-03", event: "Zeds Dead", support: "Deadrocks XII" },
  ...
  { date: "2026-07-15", event: "The Head and the Heart", support: "Colorado Symphony, Evan Honer" },
  ...
  { date: "2026-08-13", event: "Mt. Joy", support: "Special Guests" },
  { date: "2026-08-14", event: "Mt. Joy", support: "Special Guests" },
  ...
  { date: "2026-09-04", event: "Maná", support: "Vivir Sin Aire Tour" },
  { date: "2026-09-05", event: "Maná", support: "Vivir Sin Aire Tour" },
      ...
      <div className="mb-20 border-b border-white/5 pb-10 flex justify-between items-end">
        <div>
          ...
          <p className="text-red-600 font-bold uppercase tracking-[0.4em] mt-4 italic text-xs underline decoration-red-600 decoration-2 underline-offset-8">
            2026 Destination Intelligence // 90+ Events
          </p>
        </div>
        <div className="text-right hidden md:block">
           <p className="text-zinc-600 font-black uppercase text-[10px] tracking-widest mb-1">Fleet Status</p>
           <p className="text-white font-black italic uppercase text-sm italic">6 Suburbans // 2 Sprinters Active</p>
        </div>
      </div>
          ...
          <section key={month}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {shows.map((show: any, i: number) => (
                <Link 
                  key={i} 
                  href={`/shows/${show.event.toLowerCase().replace(/ /g, '-')}`}
                ...
                >
                  ...
                  <div className="mt-8 pt-8 border-t border-white/5 flex justify-between items-center">
                    <span className="text-[9px] font-black uppercase tracking-widest text-zinc-700 italic">DCC Intelligence &rarr;</span>
                    <span className="text-red-600 font-black uppercase text-[10px] italic">Active Shuttle</span>
                  </div>
                </Link>
              ))}
            </div>
