...
export const metadata = {
  title: "Summit Music Hall Map | Denver Venue Layout 2026",
  description:
    "Summit Music Hall map showing stage orientation, GA areas, entry points, bars, and nearby pickup guidance.",
    ...
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          ...
          <h1 className="comic-title">Summit Music Hall Map</h1>
        ...
        <section className="comic-panel mt-8">
          ...
          <ul className="comic-copy mt-4 space-y-3 list-disc pl-6">
            <li>
              <strong>Main Entrance</strong> - LoDo front door with security and ticket scan queue.
            </li>
            <li>
