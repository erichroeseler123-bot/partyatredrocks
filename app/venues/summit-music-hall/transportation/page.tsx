...
export const metadata = {
  title: "Summit Music Hall Transportation Guide | Denver LoDo 2026",
  description:
    "How to get to Summit Music Hall in 2026. Compare shuttle, rideshare, driving, and transit with post-show exit strategy.",
  alternates: { canonical: `${SITE}/venues/summit-music-hall/transportation` },
};

export default function SummitTransportationPage() {
  return (
    <main className="comic-page pt-24 pb-10">
      <section className="comic-wrap">
        <div className="comic-hero">
          <div className="comic-kicker">Denver Venue Guide</div>
          <h1 className="comic-title">Summit Music Hall Transportation Guide</h1>
          <p className="comic-copy">
            LoDo access is simple inbound, but post-show curb demand builds quickly. Use this plan to stay predictable.
          </p>
