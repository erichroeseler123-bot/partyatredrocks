    ...
    <main className="min-h-screen bg-surface text-white py-24 px-6">
      <div className="max-w-5xl mx-auto">
        <header className="mb-12 border-l-4 border-red-600 pl-8">
          ...
          {show.dateText ? (
            <p className="mt-4 text-sm text-zinc-500 font-bold uppercase tracking-[0.2em]">
              {show.dateText}
            </p>
          ) : null}
        </header>
        ...
        <section className="mb-20">
          ...
          {show.description ? (
            ...
            <p className="text-zinc-500 italic text-center py-10 uppercase text-xs font-bold tracking-widest">
          ...
          <div className="mt-10 flex flex-col md:flex-row gap-4">
            <Link
              href="/book-all-venue"
              className="bg-red-600 hover:bg-red-500 px-8 py-4 rounded-full font-black uppercase text-xs tracking-[0.2em] transition shadow-xl text-center"
            >
              Book Transportation
            </Link>
            ...
            {show.ticketUrl ? (
              <a
                ...
                className="bg-zinc-800 hover:bg-zinc-700 px-8 py-4 rounded-full font-black uppercase text-xs tracking-[0.2em] transition shadow-xl text-center"
              >
                Tickets
              </a>
            ) : null}
            ...
            <Link
              ...
              className="border border-zinc-800 hover:border-red-600 px-8 py-4 rounded-full font-black uppercase text-xs tracking-[0.2em] transition text-center"
            >
              2026 Hub
            </Link>
          </div>
