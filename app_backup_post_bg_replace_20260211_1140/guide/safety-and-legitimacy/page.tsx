...
export default function SafetyAndLegitimacy() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-20 bg-surface text-white">
      ...
      <section className="bg-surface-strong/50 border border-zinc-800 rounded-[2.5rem] p-8 mb-10 shadow-2xl">
        ...
        <ul className="space-y-6">
          ...
          <li className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm mt-1">We never utilize surge pricing. Your $250 group minimum or $59 seat is locked in the moment you book.</p>
            </div>
          </li>
        </ul>
      </section>
