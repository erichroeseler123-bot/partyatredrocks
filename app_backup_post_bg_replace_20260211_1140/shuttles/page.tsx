  ...
  return (
    <div className="min-h-screen bg-surface text-white font-mono selection:bg-matrix-green/30 w-full pb-20">
      <main className="p-8 lg:p-12 max-w-7xl mx-auto">
        ...
        <section className="relative w-full aspect-video lg:aspect-[21/9] bg-surface-strong border border-zinc-800 rounded-xl mb-4 flex flex-col items-center justify-center group overflow-hidden shadow-2xl">
        ...
        <section className="border-t border-zinc-800 pt-16 mb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              ...
              <a key={node.name} href={node.url} target="_blank" rel="noopener noreferrer" className="p-6 border border-zinc-800 bg-surface-strong/30 hover:border-neon-blue transition-all group">
        ...
        <section className="border-t border-zinc-800 pt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <a key={node.name} href={node.url} target="_blank" rel="noopener noreferrer" className="p-5 border border-zinc-800 bg-surface-strong/10 hover:border-matrix-green transition-all group">
