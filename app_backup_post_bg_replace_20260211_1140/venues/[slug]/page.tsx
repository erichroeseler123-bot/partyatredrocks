...
export default async function VenuePage({
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 text-white">
      ...
      <section className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-3">
          ...
          <a
            ...
            className="px-4 py-2 rounded-full bg-red-600 text-xs font-bold uppercase tracking-widest hover:bg-red-500"
          >
            Book Ride
          </a>
        </div>
      ...
      {/* EVENTS */}
      {events.length === 0 ? (
        <section className="rounded-xl border border-white/10 p-6 bg-surface">
        ...
        <section className="grid gap-6">
          {events.map((ev) => {
            ...
            return (
              <article
                key={ev.id}
                className="rounded-2xl border border-white/10 overflow-hidden bg-surface"
              >
                {performerImg ? (
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex flex-wrap gap-3">
                    ...
                    <a
                      ...
                      className="px-3 py-2 rounded-full bg-red-600 text-xs font-bold uppercase tracking-widest hover:bg-red-500"
                    >
                      Book Ride
                    </a>
                  </div>
