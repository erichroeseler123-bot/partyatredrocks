export default function RedRocksFAQ() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-10">
      <div className="bg-black/25 border border-soft rounded-[28px] p-6 md:p-8 shadow-2xl">
        <h2 className="text-2xl md:text-3xl font-black tracking-tight">Red Rocks FAQ</h2>
        <div className="mt-6 grid gap-3">
          {items.map((it) => (
            <details key={it.q} className="rounded-2xl border border-soft bg-black/20 p-4 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
