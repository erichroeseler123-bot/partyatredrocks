...
export default function RezdyWidget({ 
  ...
  return (
    <div className="w-full overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/50 backdrop-blur-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
      <iframe
        src={url}
        width="100%"
        height={height}
