    ...
    <main className="mx-auto max-w-6xl px-4 py-10 md:py-14">
      ...
      <section className="rounded-[36px] border border-white/10 bg-white/[0.04] p-8 md:p-12 shadow-[0_22px_70px_rgba(0,0,0,0.45)] backdrop-blur-xl">
        ...
        <div className="mt-7 flex flex-col gap-3 sm:flex-row">
          <Link
            href="/book"
            className="inline-flex items-center justify-center rounded-full bg-neon-blue px-8 py-4 text-[12px] font-black uppercase tracking-[0.22em] text-black hover:bg-white transition"
          >
            Book Shuttle
          </Link>
      ...
      <section className="mt-10 rounded-3xl border border-white/10 bg-white/[0.04] p-8">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={h} className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
